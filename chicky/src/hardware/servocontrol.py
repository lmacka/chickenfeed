...
class ServoController:
    ...
    def cleanup(self):
        ...
        self.pwm.stop()
        # Don't call GPIO.cleanup() here as it might affect other GPIO users
        print(f"Cleaned up GPIO pin {self.pin}")

if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python3 servo_rpi.py <GPIO_PIN> <ANGLE>")
        print("Example: python3 servo_rpi.py 14 90")
        sys.exit(1)
